package com.fotos.equipment.master.service.config;
...
@Configuration
@EnableSwagger2
public class EquipmentMasterConfig {
	...
	public Docket getDocketForSwagger() {
		return new Docket(DocumentationType.SWAGGER_2)
						.select()
							.apis(RequestHandlerSelectors.basePackage("com.fotos.equipment.master.service"))
								.build()
									.apiInfo(apiDetails());
	}
